...
return [
    ...
    |
    */
    'path' => app_path('Business/Repositories'),
    ...
    |
    */
    'criteria_path' => app_path('Business/Repositories/Criteria'),
    ...
    */
    ...
    |
    */
    'criteria_namespace' => 'Business\Repositories\Criteria',
    ...
    */
    ...
    | to specify the namespace where you domains are living at.
    |
    */
